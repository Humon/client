...
public class SteamVR_ControllerManager : MonoBehaviour
{
	...
	public void Refresh()
	{
        ...
        //@KP: Also commenting these lines to disable the regular hand controllers
        //I followed the steps from a comment in this video: https://www.youtube.com/watch?v=EicpJkKhUZA
        //
        /*
        ...
        //@KP": commented this dangling else
        //else 
        //{
        SetTrackedDeviceIndex(objectIndex++, (rightIndex < connected.Length && connected[rightIndex]) ? rightIndex : OpenVR.k_unTrackedDeviceIndexInvalid);
			...
			//@KP: I disabled this so that we don't have to connect the hand controllers connected before we pair the trackers
